...
public extension Coordinates2D where T: FixedWidthInteger {
	public func nearby (at direction: DirectionHexFlat) -> Coordinates2D<T> {
	...
	public func nearby (at direction: DirectionHexPointy) -> Coordinates2D<T> {
		var nearbyCoordinates: Coordinates2D<T>
...
extension Coordinates2D: Customizable, ClosureInitializable { }
...
extension Coordinates3D: Customizable, EmptyInitializable, ClosureInitializable { }
